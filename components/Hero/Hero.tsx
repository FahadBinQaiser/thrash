  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-[#edf2f4] max-w-5xl leading-tight mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="border-b-5 border-[#edf2f4] text-[#edf2f4] px-8 py-4 rounded-full hover:bg-[#8d99ae]/10 transition">
            See a Real Example
          </button>
        </div>
      </div>
